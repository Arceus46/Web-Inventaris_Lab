...
if(isset($_POST['submit'])){
  ...
  $denda = $_POST ['denda'];
   ...
   // Generate id_barang otomatis
    $result = mysqli_query($conn, "SELECT MAX(id_barang) AS last_id FROM barang");
    ...
    $id_barang = 'B' . str_pad($new_num, 3, '0', STR_PAD_LEFT);

  $simpan = mysqli_query ($conn,"insert into barang set 
  id_barang = '$id_barang',
...
<div class="about-area-1 space">
    <div class="container">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" name="jumlah_barang" placeholder="Isi Jumlah Barang"/>
      </div>   
      <div class="form-group">
        <label><b>Jenis Barang</b></label>
        <input type="text" class="form-control" name="jenis_barang" placeholder="Isi Jenis Barang"/>
      </div>   
      <div class="form-group">
        <label><b>Kondisi Barang</b></label>
        <input type="text" class="form-control" name="kondisi" placeholder="Jelaskan kondisi barang"/>
      </div>   
      <div class="form-group">
        <label><b>Deskripsi</b></label>
        <input type="text" class="form-control" name="deskripsi" placeholder="Isi Deskripsi Barang"/>
      </div>
      <div class="form-group">
        <label><b>Denda</b></label>
        <input type="number" class="form-control" name="denda" placeholder="Isi Denda Barang"/>
      </div>
