        ...
        <div class="container">
            <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
                <div class="text-center w-100">
                    ...
                    <h4 class="text-center"><a href="insertpinjam.php">[+]Tambah Data Peminjaman[+]</a></h4>
                            ...
                            <tbody>
                                ...
                                while ($data = mysqli_fetch_array($sql)) {
                                    ...
                                    if ($data['status'] === 'Diverifikasi') {
                                        echo "<td style='white-space: nowrap;'>Diverifikasi</td>";
                                        echo "<td style='white-space: nowrap;'><a href='pkembali.php?id=$data[id_peminjaman]'>Pengembalian</a></td>";
                                        echo "<td style='white-space: nowrap;'><a href='updatepinjam.php?id=$data[id_peminjaman]'>Update</a></td>
                                              <td style='white-space: nowrap;'><a href='deletepinjam.php?id=$data[id_peminjaman]'>Hapus</a></td>";
                                    } elseif ($data['status'] === 'Telah Dikembalikan') {
                                        echo "<td style='white-space: nowrap;' colspan='2'>Telah Dikembalikan</td>";
                                        echo "<td style='white-space: nowrap;'><a href='updatepinjam.php?id=$data[id_peminjaman]'>Update</a></td>
                                              <td style='white-space: nowrap;'><a href='deletepinjam.php?id=$data[id_peminjaman]'>Hapus</a></td>";
                                    } else {
                                        echo "<td style='white-space: nowrap;'><a href='upver.php?id=$data[id_peminjaman]'>Verifikasi</a></td>";
                                        echo "<td style='white-space: nowrap;'><a href='pkembali.php?id=$data[id_peminjaman]'>Pengembalian</a></td>";
                                        echo "<td style='white-space: nowrap;'><a href='updatepinjam.php?id=$data[id_peminjaman]'>Update</a></td>
                                              <td style='white-space: nowrap;'><a href='deletepinjam.php?id=$data[id_peminjaman]'>Hapus</a></td>";
                                    }
