...
if (isset($_POST['submit'])) {
    ...
    // Generate id_peminjaman otomatis
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <select class="form-control" name="nim">
                                <option value="" disabled selected hidden>Pilih NIM</option>
                                <?php
                                $queryUser = mysqli_query($conn, "SELECT nim, nama FROM user");
                                while ($rowUser = mysqli_fetch_assoc($queryUser)) {
                                    echo "<option value='{$rowUser['nim']}'>{$rowUser['nim']} - {$rowUser['nama']}</option>";
                                }
                                ?>
                            </select>
                        </div>
