        ...
        <div class="container">
            <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
                <div class="text-center w-100">
                    ...
                    <h4 class="text-center"><a href="insertuser.php">[+]Tambah Data User[+]</a></h4>
                    <form method="GET" action="user.php" class="mb-3 d-flex align-items-center justify-content-center">
                        <input type="text" name="cari" placeholder="Cari User" class="form-control me-2" style="max-width: 300px;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" style="font-size: 15px;">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['cari'])) {
                                    $cari = $_GET['cari'];
                                    $ambil = "SELECT * FROM user WHERE nim LIKE '%" . $cari . "%'
                                    OR nama LIKE '%" . $cari . "%'
                                    OR no_wa LIKE '%" . $cari . "%'
                                    OR Alamat LIKE '%" . $cari . "%'";
                                } else {
                                    $ambil = "SELECT * FROM user";
                                }
                                ...
                                while ($data = mysqli_fetch_array($sql)) {
                                    ...
                                    <td style='white-space: nowrap;'>$data[no_wa]</td>
                                    <td style='white-space: nowrap;'>$data[Alamat]</td>
                                    <td style='white-space: nowrap;'><a href='updateuser.php?id=$data[nim]'>Update</a></td>
                                    <td style='white-space: nowrap;'><a href='deleteuser.php?id=$data[nim]'>Hapus</a></td>
                                    </tr>
                                    ";
                                }
                                ?>
