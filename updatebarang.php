...
if(isset($_POST['submit'])) {
  $id_barang = $_GET['id']; // Use the ID from the URL parameter
  ...
  $simpan = mysqli_query($conn, "UPDATE barang SET 
...
<div class="about-area-1 space">
    <div class="container">
      ...
      <div class="form-group">
        ...
        <input type="text" class="form-control" name="id_barang" value="<?php echo $data['id_barang']; ?>" disabled>
      </div>   
      <div class="form-group">
      ...
      <div class="form-group">
        ...
        <input type="number" class="form-control" name="jumlah_barang" value="<?php echo $data['jumlah']; ?>" >
      </div>   
      <div class="form-group">
        <label><b>Jenis Barang</b></label>
        <input type="text" class="form-control" name="jenis_barang" value="<?php echo $data['jenis']; ?>" >
      </div>   
      <div class="form-group">
