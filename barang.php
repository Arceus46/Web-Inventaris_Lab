        ...
        <div class="container">
            <div class="d-flex justify-content-center align-items-center" style="min-height: 100vh;">
                <div class="text-center w-100">
                    ...
                    <h4 class="text-center"><a href="insertbarang.php">[+]Tambah Data Barang[+]</a></h4>
                    <form method="GET" action="barang.php" class="mb-3 d-flex align-items-center justify-content-center">
                        <input type="text" name="cari" placeholder="Cari Barang" class="form-control me-2" style="max-width: 300px;">
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" style="font-size: 15px;">
                            ...
                            <tbody>
                                ...
                                if (isset($_GET['cari'])) {
                                    $cari = $_GET['cari'];
                                    $ambil = "SELECT * FROM barang WHERE id_barang LIKE '%" . $cari . "%'
                                ...
                                while ($data = mysqli_fetch_array($sql)) {
                                    ...
                                    <td style='white-space: nowrap;'>$data[jenis]</td>
                                    <td style='white-space: nowrap;'>$data[kondisi]</td>
                                    <td style='white-space: nowrap;'>$data[deskripsi]</td>
                                    <td style='white-space: nowrap;'>$data[denda]</td>
                                    <td style='white-space: nowrap;'><a href='updatebarang.php?id=$data[id_barang]'>Update</a></td>
                                    <td style='white-space: nowrap;'><a href='deletebarang.php?id=$data[id_barang]'>Hapus</a></td>
                                    <td style='white-space: nowrap;'><a href='insertpinjam.php?id=$data[id_barang]'>Peminjaman</a></td>
                                    </tr>
                                    ";
                                }
                                ?>
